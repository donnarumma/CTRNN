...
function [net] = ctrnn_dual_fe_oneStep (net)%outFun,x0,W,WE,In,theta,tau,steps,deltaT)
...
%      net.outs(net.indexOut,:) * net.internalWMatrix.'
	f 	 	= - net.outs(net.indexOut,:) + outFun ( net.outs(net.indexOut,:) * net.internalWMatrix.' + net.biases + net.externalInput * net.externalWMatrix.');
    
	x 	 	=   net.outs(net.indexOut,:) + ratio .* f;
	net.indexOut 	= net.indexOut+1;
	net.outs(net.indexOut,:) = x;
end